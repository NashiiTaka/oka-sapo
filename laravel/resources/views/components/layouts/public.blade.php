  ...
  <footer>
    ...
    <div class="bg-white pt-2 sm:pt-4 lg:pt-6">
      ...
      <nav
        ...
        <a href="{{ url('/chat/index') }}" class="flex flex-col items-center gap-1 text-indigo-500 text-purple-800">
          {{--  Homeの色ここで変えられる --}}
        ...
        <a href="{{ url('/face-detection') }}"
          ...
          <svg viewBox="0 -2 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <defs> </defs>
              <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-258.000000, -467.000000)"
                  fill="#9CA3AF">
                  <path
